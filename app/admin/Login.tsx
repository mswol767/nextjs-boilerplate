      ...
      <div className="w-full max-w-sm sm:max-w-md lg:max-w-2xl xl:max-w-3xl">
        <div className="bg-white rounded-lg shadow-lg border border-gray-200 p-6 sm:p-8 lg:p-10">
          <div className="text-center mb-6 sm:mb-8">
            ...
            <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 mb-2">Admin Access</h1>
            <p className="text-sm sm:text-base lg:text-lg text-gray-600">Enter your password to continue</p>
          </div>
          
          <form onSubmit={submit} className="space-y-4 sm:space-y-6">
            <div>
              <label className="block text-sm sm:text-base lg:text-lg font-medium text-gray-700 mb-2 sm:mb-3">Admin Password</label>
              <input 
                type="password" 
                value={pass} 
            ...
            <button 
              className="w-full bg-green-600 hover:bg-green-700 text-white font-medium py-2 sm:py-3 lg:py-4 px-4 rounded-md shadow-sm hover:shadow-md transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base lg:text-lg" 
              disabled={loading} 
              type="submit"
            >
              {loading ? (
